...
BACKTEST_AGENT_INTERPRET_TIMEOUT_MS=180000
...
`BACKTEST_AGENT_INTERPRET_TIMEOUT_MS` 用于控制 AI 回测解读请求的独立超时预算。
建议至少设置为 `AGENT_LLM_REQUEST_TIMEOUT_MS + 30000`，不要再让它隐式继承 `BACKTEST_AGENT_TIMEOUT_MS`。
